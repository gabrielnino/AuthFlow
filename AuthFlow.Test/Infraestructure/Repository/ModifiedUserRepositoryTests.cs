...
namespace AuthFlow.Test.Infraestructure.Repository
{
    ...
    public class ModifiedUserRepositoryTests : BaseTests
    {
        ...
        [Test]
        public async Task When_Modified_ValidUser_Then_Success()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_InvalidUser_Then_Failed()
        {
            // Given
...
#pragma warning restore CS8600 // Converting null literal or possible null value to non-nullable type.
        ...
        [Test]
        public async Task When_Modified_InvalidUserData_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_InvalidUserData02_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_InvalidEmailEmpty_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_InvalidUsernameEmpty_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_InvalidPasswordEmpty_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_AlreadyRegistedUsername_Then_Failed()
        { 
            // Given
        ...
        [Test]
        public async Task When_Modified_AlreadyRegisteredEmail_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMinimunUsername_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMinimunEmail_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMinimunPassword_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMinimunAllField_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMaximunUsername_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMaximunEmail_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghMaximunPassword_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_LenghOverMaximunAlllFields_Then_Failed()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_ValidUser02_Then_Success()
        {
            // Given
        ...
        [Test]
        public async Task When_Modified_InvalidEmailFormat_Then_Success()
        {
            // Given
