...
namespace AuthFlow.Test._02_Core.UseCases.ExternalServices
{
    internal class ReCaptchaServiceTest
    {
        ...
        private const string MessageReCaptchaFailed = "The configuration for the log services is missing the username, password, or URL.";
